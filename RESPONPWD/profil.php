<?php
	...
	$query = mysqli_query($con, "SELECT * FROM admin  WHERE admin_id = '".$_SESSION['id']."' ");
	...
	<div class="section">
		<div class="container">
			...
			<div class="di">
				...
				<input type="text" name="NoHp" placeholder="Nomor Hp" class="input-control" value="<?php echo $d->admin_telp ?>"required>
				...
				<?php 
					if (isset($_POST['ubah_password'])) {
						...
						if($pass2 != $pass1){
							...
							$u_pass = mysqli_query($con, "UPDATE admin SET 
									password = '".MD5($pass1)."',
									WHERE admin_id ='".$d->admin_id."'");
							if ($u_pass) {
								echo '<script>alert("ubah pass berhasil")</script>';
